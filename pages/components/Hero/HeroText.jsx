...
const HeroText = ({ product, addToCard }) => {
    ...
    return (
        <>
            <h2 className="tracking-wider text-primary-orange uppercase text-sm font-bold mb-4 min-w-max">{company}</h2>
            <h1 className="text-[2rem] desktop:text-[2.9rem] font-extrabold mb-8 text-black leading-none">{name}</h1>
            <p className="text-neutral-darkgrayishblue text-[15px] desktop:text-base mb-5 leading-6">{desc}</p>
