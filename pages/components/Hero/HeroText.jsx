    ...
    return (
        <>
            ...
            <div className="mb-5">
                ...
                <span className="text-neutral-grayishblue line-through">${price.toFixed(2)}</span>
            </div>
            <div className="flex justify-between">
                ...
                <button onClick={() => addToCard(id, count)} className="flex items-center ml-4 h-12 text-base font-bold bg-primary-orange px-16 rounded-lg bg-opacity-90 hover:bg-opacity-100 transition" type="button">
