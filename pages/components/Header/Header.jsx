            ...
            <div className="flex justify-between items-center">
                <div className="flex items-center md:flex-row-reverse">
                    <nav className="flex items-end">
                        <svg id="menu" className="block md:hidden" width="16" height="15" xmlns="http://www.w3.org/2000/svg"><path d="M16 12v3H0v-3h16Zm0-6v3H0V6h16Zm0-6v3H0V0h16Z" fill="#69707D" fillRule="evenodd" /></svg>
                        <div className="absolute top-0 left-0 z-10 md:static">
                            ...
                            <ul className="flex flex-col md:flex-row md:space-x-8 md:ml-14 text-sm text-neutral-darkgrayishblue">
                                <li><a href="#" className="block pt-10 pb-12 transition border-b-4 border-transparent hover:border-b-4 hover:border-primary-orange hover:text-neutral-darkblue hover:font-semibold">Collections</a></li>
                                <li><a href="#" className="block pt-10 pb-12 transition border-b-4 border-transparent hover:border-b-4 hover:border-primary-orange hover:text-neutral-darkblue hover:font-semibold">Men</a></li>
                                <li><a href="#" className="block pt-10 pb-12 transition border-b-4 border-transparent hover:border-b-4 hover:border-primary-orange hover:text-neutral-darkblue hover:font-semibold">Women</a></li>
                                <li><a href="#" className="block pt-10 pb-12 transition border-b-4 border-transparent hover:border-b-4 hover:border-primary-orange hover:text-neutral-darkblue hover:font-semibold">About</a></li>
                                <li><a href="#" className="block pt-10 pb-12 transition border-b-4 border-transparent hover:border-b-4 hover:border-primary-orange hover:text-neutral-darkblue hover:font-semibold">Contact</a></li>
                            </ul>
                        </div>
                    </nav>
                ...
                <div className="flex items-center">
                    <div className="relative">
                        <div className="relative">
                            ...
                            <svg onMouseEnter={() => setIsCartShown(true)} onMouseLeave={() => console.log('onMouseLeave')} className="hover:cursor-pointer fill-neutral-darkgrayishblue transition opacity-90 hover:opacity-100" width="22" height="20" xmlns="http://www.w3.org/2000/svg"><path d="M20.925 3.641H3.863L3.61.816A.896.896 0 0 0 2.717 0H.897a.896.896 0 1 0 0 1.792h1l1.031 11.483c.073.828.52 1.726 1.291 2.336C2.83 17.385 4.099 20 6.359 20c1.875 0 3.197-1.87 2.554-3.642h4.905c-.642 1.77.677 3.642 2.555 3.642a2.72 2.72 0 0 0 2.717-2.717 2.72 2.72 0 0 0-2.717-2.717H6.365c-.681 0-1.274-.41-1.53-1.009l14.321-.842a.896.896 0 0 0 .817-.677l1.821-7.283a.897.897 0 0 0-.87-1.114ZM6.358 18.208a.926.926 0 0 1 0-1.85.926.926 0 0 1 0 1.85Zm10.015 0a.926.926 0 0 1 0-1.85.926.926 0 0 1 0 1.85Zm2.021-7.243-13.8.81-.57-6.341h15.753l-1.383 5.53Z" fillRule="nonzero" /></svg>
                        </div>
                        {
                            isCartShown &&
                    ...
                    <Image className="ml-5 md:ml-8 hover:cursor-pointer transition border-2 rounded-full border-transparent hover:border-2 hover:rounded-full hover:border-primary-orange hover:border-opacity-80" src='/images/image-avatar.png' alt='Logo' width={50} height={50} />
                </div>
            </div>
        </header>
    )
