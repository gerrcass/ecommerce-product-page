...
const CartIcon = ({ cartItems, isCartShown, setIsCartShown }) => (
    <button
        type="button"
        className="relative "
    ...
    >
        ...
        <svg
            className="hover:cursor-pointer fill-neutral-darkgrayishblue transition duration-75 opacity-90 hover:opacity-100 active:scale-105"
            width="22"
            height="20"
